...
- Built in `Python` using `streamlit`, `pandas` , `matplotlib` , `investpy` , and `tensorflow`.
''')
st.write('---')
...
tickerSymbol = st.sidebar.selectbox('Crypto ticker', ticker_list) # Select ticker symbol
